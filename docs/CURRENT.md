...
| 范围 | 实现 | 测试 |
|---|---|---|
| `symbio/src` | 205 文件 / 52492 行 | 68 文件 / 21305 行 |
| `cli/src` | 4 文件 / 1445 行 | 0 文件 / 78 行 |
| `tauri/src-tauri/src` | 3 文件 / 392 行 | 0 文件 / 0 行 |
| `tauri/src` | 96 文件 / 19746 行 | 46 文件 / 9784 行 |
...
> 生成时间：2026-09-22 10:59:29 UTC · 源：`git rev-parse HEAD` = `b641f10`
