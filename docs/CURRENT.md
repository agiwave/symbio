...
| 范围 | 实现 | 测试 |
|---|---|---|
| `symbio/src` | 205 文件 / 51792 行 | 64 文件 / 20618 行 |
| `cli/src` | 4 文件 / 1442 行 | 0 文件 / 78 行 |
| `tauri/src-tauri/src` | 3 文件 / 346 行 | 0 文件 / 0 行 |
| `tauri/src` | 96 文件 / 19369 行 | 46 文件 / 9255 行 |
...
> 生成时间：2026-09-22 08:47:54 UTC · 源：`git rev-parse HEAD` = `6fe41ed`
