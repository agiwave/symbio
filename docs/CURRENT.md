...
| 范围 | 实现 | 测试 |
|---|---|---|
| `symbio/src` | 205 文件 / 52131 行 | 66 文件 / 20909 行 |
| `cli/src` | 4 文件 / 1458 行 | 0 文件 / 78 行 |
| `tauri/src-tauri/src` | 3 文件 / 346 行 | 0 文件 / 0 行 |
| `tauri/src` | 96 文件 / 19392 行 | 46 文件 / 9362 行 |
...
> 生成时间：2026-09-22 09:47:15 UTC · 源：`git rev-parse HEAD` = `87c96ac`
