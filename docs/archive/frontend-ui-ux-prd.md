...
> **【归档说明】** 本文档是 **2026-09-02 的前端 UI/UX 需求稿（PRD v1.0，过程产物）**：状态停在
> 「待用户拍板」，其中的页面与路由清单已与现状脱节，且无文档引用。已于 2026-09-17 移入
> `docs/archive/`。前端现行结构见 [`tauri/docs/FRONTEND.md`](../../tauri/docs/FRONTEND.md)。本文不再更新。
