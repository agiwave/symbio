...
> **【归档说明】** 本文档是 **2026-09-02 的前端 UI/UX 设计稿（过程产物）**：所依据的 PRD 与其中的
> 页面清单已与现状脱节，且无文档引用。已于 2026-09-17 移入 `docs/archive/`。
> 前端现行结构见 [`tauri/docs/FRONTEND.md`](../../tauri/docs/FRONTEND.md)。本文不再更新。
